                ...
                <div class="card-body">
                    ...
                    <form action="${pageContext.request.contextPath}/signup" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg fs-6" name="username" pattern="^\S+$"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control form-control-lg fs-6" name="email" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text"
                                       ...
                                       name="mobile"
                                       pattern="^(?:0|94|\+94)7[0-8]\d{7}$"
                                       title="Enter a valid Sri Lankan mobile number (e.g., 0771234567 or +94711234567)"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <label class="form-label text-muted small fw-bold text-uppercase">Confirm
                                    Password</label>
                                <input type="password" class="form-control form-control-lg fs-6" name="rePassword"
                                       minlength="6" required>
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-4 pt-3 border-top">
                        ...
                        <a href="${pageContext.request.contextPath}/login"
                           class="text-decoration-none fw-bold text-primary">Log In</a>
                    </div>
                </div>
            </div>
        </div>
